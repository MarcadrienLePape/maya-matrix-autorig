...
def UI():
    ...
    aboutFrame = cmds.frameLayout("about", 
                                  label='News & Updates', 
                                  cll=1, 
                                  cl=0, 
                                  bv=0, 
    ...
    aboutLayout = cmds.formLayout("aboutLayout", 
    ...
    cmds.setParent(aboutLayout, aboutFrame)
    cmds.setParent(aboutFrame, mainLayout)
    cmds.setParent(mainColumn, mainScroll)
    cmds.setParent(mainScroll, mainLayout)
